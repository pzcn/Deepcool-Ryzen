...
* - The Console Application can be built using Visual Studio solution file(compatible with Visual Studio 2022) available in the AMDRyzenMasterMonitoringSampleApp folder
