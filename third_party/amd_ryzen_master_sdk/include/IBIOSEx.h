...
* @param uVDDioMV [out] Reference of unsigned short variable which will hold current memory VDDIO voltage supply value
...
* @param uMemClock [out] Reference of unsigned short variable which will hold current memory clock frequency
* @return Status of function call
*	- 0 --> Function call is successful
*	- 2 --> Method is not implemented by the BIOS
*	- -1 --> Failure in execution of the command in BIOS
...
* @param uTcl [out] Reference of unsigned character variable which will hold CAS latency value
* @return Status of function call
*	- 0 --> Function call is successful
*	- 2 --> Method is not implemented by the BIOS
*	- -1 --> Failure in execution of the command in BIOS
...
* @param uTrcdrd [out] Reference of unsigned character variable which will hold read row address to column address delay.
* @return Status of function call
*	- 0 --> Function call is successful
*	- 2 --> Method is not implemented by the BIOS
*	- -1 --> Failure in execution of the command in BIOS
...
* @param uTras [out] Reference of unsigned character variable which will hold row active time.
* @return Status of function call
*	- 0 --> Function call is successful
*	- 2 --> Method is not implemented by the BIOS
*	- -1 --> Failure in execution of the command in BIOS
...
* @param uTrp [out] Reference of unsigned character variable which will hold row precharge delay.
* @return Status of function call
*	- 0 --> Function call is successful
*	- 2 --> Method is not implemented by the BIOS
*	- -1 --> Failure in execution of the command in BIOS
